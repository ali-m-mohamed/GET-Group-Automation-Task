...
public class BasePage {
    ...
    public static String firstName = dataProperty.getProperty("firstname");
    public static String lastName = dataProperty.getProperty("lastname");
    public static String mobileNumber = dataProperty.getProperty("mobile");
    public static String mailAddress = dataProperty.getProperty("mail");
    public static String Password = dataProperty.getProperty("password");
